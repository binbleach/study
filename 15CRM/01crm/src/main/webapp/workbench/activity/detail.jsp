        ...
        $("#saveRemarkBtn").click(function () {
            $.ajax({
                ...
                success:function (n) {
                    if (n.success==true){
                    var html = "";
                    html += '<div class="remarkDiv" id="'+n.ar.id+'" style="height: 60px;">';
                    html += '<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                    html += '<div style="position: relative; top: -40px; left: 40px;" >';
                    html += '<h5 id="a'+n.ar.id+'">'+n.ar.noteContent+'</h5>';
                    html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>'+"${a.name}"+'</b> <small style="color: gray;" id="b'+n.ar.id+'"> '+(n.ar.editFlag==0?n.ar.createTime:n.ar.editTime)+' 由'+(n.ar.editFlag==0?n.ar.createBy:n.editBy)+'</small>';
                    html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                    html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+n.ar.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>';
                    html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                    html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\''+n.ar.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
                    html += '</div>';
                    html += '</div>';
                    html += '</div>';
                    $("#one").after(html);
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success){
                        $("#a"+id).html(data.ar.noteContent);
                        $("#b"+id).html(data.ar.editTime+"由"+data.ar.editBy);
