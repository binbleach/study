...
<div id="brall">
    ...
    <div id="condition" style="text-align: center">
        <form id="myform">
            ...
            <c:forEach items="${selectCondition}" var="pt">
                <option value="${pt.typeId}">${pt.typeName}</option>
            </c:forEach>
        </select>&nbsp;&nbsp;&nbsp;
            价格：<input name="lprice" id="lprice">-<input name="hprice" id="hprice">
            <input type="button" value="查询" onclick="selectCondition()">
        </form>
    </div>
    <br>
    <div id="table">
    ...
    function ajaxsplit(page) {
        ...
        url:"${pageContext.request.contextPath}/prod/ajaxsplit.action",
            ...
            success:function () {
                ...
                //加载，刷新http://localhost:8080/mimissm/admin/product.jsp这个页面下的 id为table的标签
                $("#table").load("http://localhost:8080/mimissm/admin/product.jsp #table");
            }
        })
    };
